...
contract("Election", function(accounts) {
  ...
  it("it initializes the candidates with the correct values", function() {
    return Election.deployed().then(function(instance) {
      ...
      assert.equal(candidate[1], "Candidate C", "contains the correct name");
      ...
      assert.equal(candidate[1], "Candidate D", "contains the correct name");
      ...
      assert.equal(candidate[1], "Candidate E", "contains the correct name");
